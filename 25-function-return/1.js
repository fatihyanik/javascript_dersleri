...
//   function farkiBul(dizi) {
//     // Dizinin uzunluğunu kontrol et
//     if (dizi.length === 0) {
//         return "Dizi boş!";
//     }

//     // Başlangıçta en büyük ve en küçük değerleri belirle
//     let enBuyuk = dizi[0];
//     let enKucuk = dizi[0];

//     // Diziyi dolaşarak en büyük ve en küçük değerleri bul
...
//     // Farkı hesapla ve geri döndür
//     const fark = enBuyuk - enKucuk;
//     return fark;
// }

// // Örnek bir dizi
// const myArray = [4, 8, 2, 10, 5];

// // Fonksiyonu çağır ve sonucu yazdır
// console.log("En büyük ve en küçük değerler arasındaki fark:", farkiBul(myArray));

const fetchData = async () => { 
    try {
      const response = await fetch('https://restcountries.eu/rest/v2/all', { timeout: 5000 }); // Timeout set to 5 seconds
